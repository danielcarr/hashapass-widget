...
class HashapassWidget:
    ...
    def __init__(self, window):
        ...
        self.entry_parameter = ttk.Entry(frame, width=20, textvariable=self.parameter)
        ...
        self.entry_master_password = ttk.Entry(frame, width=16, textvariable=self.password, show='*')
